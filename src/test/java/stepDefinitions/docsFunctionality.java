...
public class docsFunctionality extends setUp {
    ...
    public void user_can_see_created_doc_on_the_page() {
        wait.until(ExpectedConditions.presenceOfElementLocated(elementPageDocsFiles.getCreatedDoc())).isDisplayed();
    }

    @When("user clicks created Docs")
    public void user_clicks_created_docs() {
        wait.until(ExpectedConditions.presenceOfElementLocated(elementPageDocsFiles.getCreatedDoc())).click();
    }
    ...
    public void user_clicks_archive_this_button() {
        wait.until(ExpectedConditions.presenceOfElementLocated(elementPageDocsFiles.getButtonArchiveDoc())).click();
    ...
    public void user_clicks_on_comment_section() {
        wait.until(ExpectedConditions.presenceOfElementLocated(elementPageDocsFiles.getButtonAddComments())).click();
    }
